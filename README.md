...
- Material-UI input and tag components by default.

### Why
Because I did not need the dependency on DnD, and wanted to play around with publishing a component.
